...
let MixedhostelSchema = mongoose.Schema(
  {
    img_array: {
...
let MixedhostelModel =
  mongoose.model.MixedhostelTable ||
  mongoose.model("MixedhostelTable", MixedhostelSchema);

// Export the model
module.exports = MixedhostelModel;
