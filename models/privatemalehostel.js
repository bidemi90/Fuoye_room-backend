...
// Define the schema for the Private Male Hostel
let PrivatemaleHostelSchema = mongoose.Schema(
  {
    img_array: {
      type: String, // link of image URLs
      required: true, // Images are optional
    },
...
// Create the model for Private Male Hostel
let PrivatemaleHostelModel =
  mongoose.model.PrivatemaleHostelTable ||
  mongoose.model("PrivatemaleHostelTable", PrivatemaleHostelSchema);

// Export the model
module.exports = PrivatemaleHostelModel;
