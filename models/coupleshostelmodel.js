...
let CoupleshostelSchema = mongoose.Schema(
  {
    img_array: {
...
let CoupleshostelModel =
  mongoose.model.CoupleshostelTable ||
  mongoose.model("CoupleshostelTable", CoupleshostelSchema);

// Export the model
module.exports = CoupleshostelModel;
