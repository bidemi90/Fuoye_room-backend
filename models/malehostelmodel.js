...
// Define the schema for the Male Hostel
...
// Create the model for Male Hostel
let MaleHostelModel =
  mongoose.model.MaleHostelTable ||
  mongoose.model("MaleHostelTable", MaleHostelSchema);

// Export the model
module.exports = MaleHostelModel;
